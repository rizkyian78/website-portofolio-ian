      ...
      <Fade>
        ...
        >
          ...
          <TabPane tab="Masdera Communication" key="3">
            ...
            Analyze the procurement needs of goods and / or services requested
            by other workers to meet the procurement of goods and / or services
            <li>
              <br />
              <span style={{ textAlign: 'justify' }}>
                <IconFont type="icon-24gl-nextFrame" id={style.list} />{' '}
          ...
          <TabPane tab="CV Jaya Ice Cream" key="5">
            ...
            Worked with a team of three Marketing to build a marketing
            Strategies to make sales more impactful, an ambitious company
            originating from Malang affiliated with Diamond Ice Cream
            <br />
            <br />
            <span style={{ textAlign: 'justify' }}>
              <IconFont type="icon-24gl-nextFrame" id={style.list} />{' '}
